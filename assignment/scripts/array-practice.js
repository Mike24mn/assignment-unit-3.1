...
let favoriteFoods = ['Pizza', 'Tacos', 'Chips'];
...
let entree = 'Grilled Salmon';
favoriteFoods.unshift(entree);
console.log('Added a new entree to beginning: ${favoriteFoods}');
...
// Explanation: Starting at index 1, AKA Citrine, delete count at index 1 
// and replace index 1 with the string "Tourmaline"
